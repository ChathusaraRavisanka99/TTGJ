/** Diagonal stage-light beams sweeping across the hero, staggered — the
 * Metal/Rock page's signature atmosphere, standing in for a concert stage
 * rather than any literal instrument illustration. */
